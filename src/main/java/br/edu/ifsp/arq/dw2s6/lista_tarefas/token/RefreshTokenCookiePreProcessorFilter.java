package br.edu.ifsp.arq.dw2s6.lista_tarefas.token;
	  ...
	  if ("/oauth/token".equalsIgnoreCase(req.getRequestURI())
	    ...
	    String refreshToken = 
	        Stream.of(req.getCookies()) // Transformar o array de cookies em um Stream
	            ...
	            .map(cookie -> cookie.getValue()) // TransformÃ¡-lo de cookie em uma String com o seu valor.
	            .orElse(null); // Caso nÃ£o tenha encontrado um cookie com o nome refreshToken, retorna null.
